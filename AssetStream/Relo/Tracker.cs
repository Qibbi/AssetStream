    ...
    public sealed class Tracker : IDisposable
    {
        ...
        internal sealed class Block
        {
            ...
            public Block(uint size)
            {
                ...
                Size = size;
                MsVcRt.MemSet(Data, 0, (nint)size);
            }
        }
        ...
        public static Tracker NullTracker { get; } = new();

        private uint _instanceBufferSize;
        private readonly List<uint> _stack = new();
        private readonly List<Block> _blocks = new();
        private readonly List<Bookmark> _relocations = new();
        private readonly List<Bookmark> _imports = new();
        ...
        public unsafe Tracker(void** rootPointer, uint size, bool isBigEndian)
        {
        ...
        public static unsafe void ByteSwap16(ushort* value)
        {
        ...
        public static unsafe void ByteSwap32(uint* value)
        {
            byte* pValue = (byte*)value;
            uint result;
            byte* pResult = (byte*)&result;
        ...
        public unsafe bool MakeRelocatable(Chunk chunk)
        {
            ...
            fixed (byte* instanceBuffer = &chunk.InstanceBuffer[0])
            {
                ...
                {
                    MsVcRt.MemCpy((IntPtr)instanceBufferPosition, block.Data, (nint)block.Size);
